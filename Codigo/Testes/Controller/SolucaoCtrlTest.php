...
//Necessita da tabela solucao(cod, descricao, data_solucao) criada no banco de dados para executar os testes.
...
class SolucaoCtrlTest extends PHPUnit_Framework_TestCase {
    ...
    public function testListaSolucao() {
        ...
        foreach ($resultado as $row){
            ...
            $this->assertArrayHasKey("data_solucao", $row, "Não foi possível listar todas as soluções!");
        }
    }
